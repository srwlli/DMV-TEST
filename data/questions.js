...
const QUESTIONS = [
  ...
  // ─────────────── SAFE DRIVING & SHARING THE ROAD (8) ───────────────
  {
    id: 'saf-001', category: 'traffic-rules', subcategory: 'following-distance', difficulty: 'medium',
    text: 'What minimum following distance does the manual recommend behind the vehicle ahead?',
    image_url: null,
    options: [
      { id: 'a', text: 'One vehicle length for every 10 mph of travel, or four seconds', correct: true },
      { id: 'b', text: 'One car length total, regardless of speed', correct: false },
      { id: 'c', text: 'Two seconds at any speed', correct: false },
      { id: 'd', text: 'Ten feet per 10 mph', correct: false },
    ],
    explanation: 'Keep a minimum following distance of one vehicle length for every 10 mph of travel, or four seconds, from the vehicle ahead.',
    source: manualSrc(34, 'Section 8 — Space Management'),
  },
  {
    id: 'saf-002', category: 'traffic-rules', subcategory: 'following-distance', difficulty: 'medium',
    text: 'Using the four-second rule, how do you know you are following too closely?',
    image_url: null,
    options: [
      { id: 'a', text: 'If you can see the vehicle ahead', correct: false },
      { id: 'b', text: 'If you pass a fixed point before counting four seconds after the vehicle ahead passed it', correct: true },
      { id: 'c', text: 'If you count more than four seconds', correct: false },
      { id: 'd', text: 'If the vehicle ahead brakes', correct: false },
    ],
    explanation: 'When the vehicle ahead passes a fixed point, count the seconds until you reach it; if you arrive before four seconds, you are following too closely.',
    source: manualSrc(34, 'Section 8 — Space Management'),
  },
  {
    id: 'saf-003', category: 'traffic-rules', subcategory: 'following-distance', difficulty: 'medium',
    text: 'When should you increase your following distance?',
    image_url: null,
    options: [
      { id: 'a', text: 'Only in heavy traffic', correct: false },
      { id: 'b', text: 'When visibility is limited by weather or darkness, or on slippery roads', correct: true },
      { id: 'c', text: 'Never — four seconds always works', correct: false },
      { id: 'd', text: 'Only on the highway', correct: false },
    ],
    explanation: 'Increase your following distance when visibility is lessened by weather (fog, rain, snow) or at night, and on slippery roads.',
    source: manualSrc(34, 'Section 8 — Space Management'),
  },
  {
    id: 'saf-004', category: 'traffic-rules', subcategory: 'pavement-markings', difficulty: 'hard',
    text: 'A center lane is marked with a broken yellow line and a solid yellow line on each side, plus turn arrows. What is it for?',
    image_url: null,
    options: [
      { id: 'a', text: 'Passing slower traffic', correct: false },
      { id: 'b', text: 'Left turns only, from either direction', correct: true },
      { id: 'c', text: 'A carpool lane', correct: false },
      { id: 'd', text: 'Through travel in one direction', correct: false },
    ],
    explanation: 'A two-way left turn lane is for left turns only; vehicles from either direction may use it just before turning left. It is not for traveling or passing.',
    source: manualSrc(17, 'Section 4 — Two-Way Left Turn Only Lane'),
  },
  {
    id: 'saf-005', category: 'traffic-rules', subcategory: 'pedestrians', difficulty: 'easy',
    text: 'What must you do at a crosswalk where a pedestrian is entering or in it?',
    image_url: null,
    options: [
      { id: 'a', text: 'Yield the right-of-way to the pedestrian', correct: true },
      { id: 'b', text: 'Proceed if you arrived first', correct: false },
      { id: 'c', text: 'Honk to warn them', correct: false },
      { id: 'd', text: 'Speed up to clear the crosswalk', correct: false },
    ],
    explanation: 'You must yield the right-of-way to pedestrians entering or in a crosswalk; if there is a stop line before the crosswalk, obey it.',
    source: manualSrc(17, 'Section 4 — Crosswalks'),
  },
  {
    id: 'saf-006', category: 'traffic-rules', subcategory: 'weather-driving', difficulty: 'medium',
    text: 'What is the best way to avoid loss of traction from hydroplaning?',
    image_url: null,
    options: [
      { id: 'a', text: 'Accelerate to push through the water', correct: false },
      { id: 'b', text: 'Slow down when driving in rain or on water-pooled roads', correct: true },
      { id: 'c', text: 'Brake hard', correct: false },
      { id: 'd', text: 'Turn sharply', correct: false },
    ],
    explanation: 'Hydroplaning happens when tires ride on top of pooled water. The best way to avoid it is to slow down in the rain and on wet, pooled roads.',
    source: manualSrc(33, 'Section 8 — Speed Management'),
  },
  {
    id: 'saf-007', category: 'traffic-rules', subcategory: 'seatbelt', difficulty: 'easy',
    text: 'Should safety belts be worn in a vehicle equipped with air bags?',
    image_url: null,
    options: [
      { id: 'a', text: 'No, air bags replace safety belts', correct: false },
      { id: 'b', text: 'Yes — air bags are supplemental and work best with safety belts', correct: true },
      { id: 'c', text: 'Only the driver needs a belt', correct: false },
      { id: 'd', text: 'Only on the highway', correct: false },
    ],
    explanation: 'Air bags are supplemental restraints designed to work with safety belts; belts should be worn even if the vehicle has air bags.',
    source: manualSrc(9, 'Section 2 — Safety Restraints'),
  },
  {
    id: 'saf-008', category: 'traffic-rules', subcategory: 'seatbelt', difficulty: 'easy',
    text: 'Who does Ohio’s mandatory safety belt law require to wear a belt?',
    image_url: null,
    options: [
      { id: 'a', text: 'Only children', correct: false },
      { id: 'b', text: 'Drivers and front-seat occupants of most passenger vehicles', correct: true },
      { id: 'c', text: 'Only the driver', correct: false },
      { id: 'd', text: 'No one — it is optional', correct: false },
    ],
